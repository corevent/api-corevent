...
export class QueryMyEventsDto extends QueryPaginationDto {
  @ApiPropertyOptional({ description: 'Search by title' })
  @IsString()
  @IsOptional()
  search?: string

  @ApiPropertyOptional({ description: 'Filter by state ID', example: 35 })
  @IsInt()
  @IsOptional()
  stateId?: number

  @ApiPropertyOptional({ description: 'Filter by city ID', example: 3525300 })
  @IsInt()
  @IsOptional()
  cityId?: number

  @ApiPropertyOptional({ description: 'Filter by category', example: EventCategory.MUSIC })
  @IsEnum(EventCategory)
  @IsOptional()
  category?: EventCategory

  @ApiPropertyOptional({ description: 'Filter by event start date', example: '2026-01-01T00:00:00.000Z' })
  @IsDate()
  @IsOptional()
  startDate?: Date

  @ApiPropertyOptional({ description: 'Filter by event status', example: EventStatus.OPENED })
  @IsEnum(EventStatus)
  @IsOptional()
  status?: EventStatus

  @ApiPropertyOptional({ description: 'Filter by event is adult only', example: false })
  @IsBoolean()
  @IsOptional()
  isAdultOnly?: boolean
}

export class QueryMyStaffEventsDto extends QueryPaginationDto {
  @ApiPropertyOptional({ description: 'Filter by event status', example: EventStatus.OPENED })
  @IsEnum(EventStatus)
  @IsOptional()
  status?: EventStatus

  @ApiPropertyOptional({ description: 'Filter by staff access level', example: EventStaffAccessLevel.READONLY })
...
export class MyStaffEventDto {
  ...
  @ApiProperty({ description: 'Staff access level', enum: EventStaffAccessLevel })
  accessLevel!: EventStaffAccessLevel
...
export class PaginateMyStaffEventsDto {
  @ApiProperty({ description: 'List of staff events', type: [MyStaffEventDto] })
  data!: MyStaffEventDto[]
